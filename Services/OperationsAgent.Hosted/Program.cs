...
// RegisterProtocol for us, so it is called here. Requires Foundry.Hosting 1.20 or later: 1.19 bound
// PORT twice inside the hosted runtime and the container never started - the collision, and how to
// reproduce the sandbox on a laptop, are in docs/product-status/hosted-agent.md.
