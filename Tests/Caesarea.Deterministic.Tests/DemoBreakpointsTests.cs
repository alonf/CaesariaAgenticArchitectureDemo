...
public sealed class DemoBreakpointsTests
{
    ...
    public void SnippetIdentifiersAreStableSemanticValues()
    {
        ...
        Assert.Equal(
            ["A2A_SPECIALIST", "AGENT_CREATION", "AGENT_SESSION", "AGENT_SKILLS", "CASE_MEMORY", "FUNCTION_TOOL", "KNOWLEDGE_RETRIEVAL", "MCP_CLIENT", "MCP_SERVER", "MULTI_AGENT", "MULTI_ROUND_TRIP_REQUEST", "TOOL_APPROVAL", "WORKFLOW"],
